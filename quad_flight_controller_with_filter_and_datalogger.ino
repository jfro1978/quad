...
float pid_error_roll_prev, pid_error_pitch_prev, pid_error_yaw_prev = 0;
...
///////////////////////////////////////////////////////////////////////////////////
float pid_p_roll_gain = 0; //was 1.5
float pid_i_roll_gain = 0.05;
float pid_d_roll_gain = 0; //was 25; 
...
//  Serial.begin(9600);
  ...
  receiver_channel_1 = 1500;
  receiver_channel_2 = 1500;
  receiver_channel_3 = 1100;
  receiver_channel_4 = 1500;
...
*/  
  ...
  myFile = SD.open("Quad.txt", FILE_WRITE);

  if(myFile)
  {
    myFile.print("Gyro pitch calibrated = ");
    myFile.println(gyro_pitch_cal);
    myFile.print("Gyro roll calibrated = ");
    myFile.println(gyro_roll_cal);
    myFile.print("Gyro yaw calibrated = ");
    myFile.println(gyro_yaw_cal);
    myFile.println("Gyro Pitch, Gyro Roll, Gyro Yaw, Front Left, Front Right, Rear Left, Rear Right, Gyro Pitch, Pitch Error, Pitch P output, Pitch I output, Pitch D output, Total Controller Output, Previous I Output, Previous Pitch Error");
    myFile.close();
  }
...
//  {
    ...
    //Code to reset the PID controllers. Once the rotors are turning, the resets below won't occur since start NEQ 1.
/*    
...
if(start == 2)
  ...
  */
  if(start == 2 & receiver_channel_3 > 1050)
  {
    myFile = SD.open("Quad.txt", FILE_WRITE);
    myFile.print(pitch_raw);
    myFile.print(",");
    myFile.print(roll_raw);
    myFile.print(",");
    myFile.print(yaw_raw);
    myFile.print(",");
    myFile.print(esc_fl);
    myFile.print(",");
    myFile.print(esc_fr);
    ...
    myFile.print(esc_rr);
    myFile.print(",");
    myFile.print(gyro_pitch);
    myFile.print(",");
    myFile.print(pid_error_pitch);
    myFile.print(",");
    myFile.print(pid_p_pitch_output);
    myFile.print(",");
    myFile.print(pid_i_pitch_output);
    myFile.print(",");
    myFile.print(pid_d_pitch_output);
    myFile.print(",");
    myFile.print(pid_pitch_output);
    myFile.print(",");
    myFile.print(pid_i_pitch_output_prev);
    myFile.print(",");
    myFile.println(pid_error_pitch_prev);
    myFile.close();
  } 
//End of main loop
